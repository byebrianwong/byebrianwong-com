...
export const APPS: AppCard[] = [
  ...
  { id: "edm-atlas", pack: "arcade", name: "EDM Atlas", tagline: "Map the world of EDM", type: "Music", icon: "🗺️", year: 2026, accent: "#d946ef", hp: 95, rarity: "rare", link: "#", stats: { users: "—", rating: "—", platform: "In dev" }, blurb: "Explore electronic dance music as an interactive atlas — chart genres, subgenres, and the artists that connect them across the globe. Currently in private development." },
];
