  ...
  return (
    <main className="about">
      <div className="about-card">
        ...
        <p>
          Hi! I&apos;m Brian, an SF Bay Area native who enjoys building fun things and playing
          sportsballs. Come check out some weird tools, apps, and games I&apos;ve built.
        </p>
        <p>
          ...
          If you actually like to touch grass and the real analog world, check out stationery and
